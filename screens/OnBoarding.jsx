    ...
    const onBoardingSteps = [
      {
        ...
        description: "Con la ayuda de ésta aplicación puedes obtener recetas para tu día a día usando productos LA MORENA.",
              ...
              <View key={`main-container-${index}`}>
                ...
                >
                  <Image
                    key={`image-${index}`}
                    source={step.image}
                    style={[OnBoardingStyles.image, { height: height * 0.35, width: width }]}
                  />
                </View>
                <View
                  style={[
